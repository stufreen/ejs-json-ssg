...
var findLocales_1 = __importDefault(require("./findLocales"));
...
function renderPages(_a) {
    var rootNode = _a.rootNode, templateDir = _a.templateDir, outputDir = _a.outputDir, contentDir = _a.contentDir;
    var templateMap = findTemplates_1.default(templateDir, '.ejs');
    logger_1.default.debug('Found templates:\n' + JSON.stringify(templateMap, null, 2));
    var localeMap = findLocales_1.default(contentDir);
    logger_1.default.debug("Found locales: " + JSON.stringify(localeMap, null, 2));
    var localeJobs = Object.keys(localeMap).map(function (localeKey) {
        logger_1.default.debug("Rendering pages for locale " + localeKey);
        return fs_1.promises
            .readFile(localeMap[localeKey], 'utf-8')
            .then(function (localeFileContents) { return JSON.parse(localeFileContents); })
            .then(function (translationTree) {
            logger_1.default.silly(localeMap[localeKey] + ":\n" + JSON.stringify(translationTree, null, 2));
        });
    });
    return Promise.all(localeJobs).then(function () {
        return;
    });
    // return compilePage({
    //   rootNode,
